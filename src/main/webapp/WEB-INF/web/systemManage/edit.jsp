...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<%@taglib prefix="nuoplus" uri="http://nuoplus.com/system/tags/zhang-functions" %>
<html>
<head>
    <title></title>
...
<body>
    ...
    <form:form method="post" commandName="role">
        ...
        <div class="form-group">
            ...
            <input type="text" id="resourceName" name="resourceName" value="${nuoplus:resourceNames(role.resourceIds)}" readonly>
    ...
    <script>
        $(function () {
            ...
            var zNodes =[
                ...
                { id:${r.id}, pId:${r.parentId}, name:"${r.name}", checked:${nuoplus:in(role.resourceIds, r.id)}},
                </c:if>
                </c:forEach>
            ];
